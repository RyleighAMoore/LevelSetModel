...
saddlelisty=[]
count =0
for filename in os.listdir('C:/Users/Rylei/MATLAB/Projects/GitLevelSetModel/PercVals/085_05/'):
    count = count +1
    print(count)
    matrix=pd.read_csv('C:/Users/Rylei/MATLAB/Projects/GitLevelSetModel/PercVals/085_05/'+filename,header=None).to_numpy()
...
PercLevels=pd.read_csv('C:/Users/Rylei/MATLAB/Projects/GitLevelSetModel/PercVals/PercVals085_05.csv',header=None).to_numpy()
...
#plt.show()
PercList = PercLevels.T

fig3 = plt.figure()
plt.hist(saddlelistz, density=True, alpha=0.5)
plt.hist(PercList, density=True, alpha=0.5)
